...
# sounds = 
#   * src: \bg.mp3, id: bg
#   * src: \intro_animation_transition.mp3, id: intro

# createjs.Sound
#   ..alternate-extensions = [\mp3]
#   ..add-event-listener \fileload, play-sound
#   ..register-sounds sounds, assets-path

# !function play-sound event
#   instance = createjs.Sound.play intro
#     ..on \complete, handle-complete, this 
